...
- For day 2, we introduce a new ability to set gas price per batch of transactions.
- This helps us to prioritize transactions hence have a better chance to go into blocks.